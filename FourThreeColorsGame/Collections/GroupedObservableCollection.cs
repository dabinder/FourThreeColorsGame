...
/*
 * GroupedObservableCollection class, taken from https://github.com/mikegoatly/GroupedObservableCollection
 */
...
namespace FourThreeColorsGame.Collections {
	public class GroupedObservableCollection<TKey, TElement> : ObservableCollection<Grouping<TKey, TElement>>
		...
		public GroupedObservableCollection(Func<TElement, TKey> readKey, IEnumerable<TElement> items) : this(readKey) {
